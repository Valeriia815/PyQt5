...
questions = [
    Question("рукавиці", "mittens", "gown", "apron", "matten"),
    Question("досвід", "experience", "exerience", "assistant", "tips"),
    Question("зарплата", "salary", "afraid", "advice", "security"),
    Question("терапевт", "therapist", "trainers", "taxi driver", "accountant"),
    Question("розклад", "timetable", "order", "success", "duties"),
    Question("сніговик", "snowman", "snow", "snowflake", "tree"),
    Question("диван", "sofa", "car", "window", "table"), 
    Question("девіз", "motto", "inn", "matta", "sea"),
    Question("тунець", "tuna", "salmon", "ham", "sausage")
]
shuffle(questions)
current_question = 0
